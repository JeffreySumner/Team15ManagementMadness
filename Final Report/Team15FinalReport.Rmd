...
formula: $$(FGA - OR) + TO + (Y * FTA)$$,where FGA = field goal attempts, OR = offensive rebounds, TO = turnovers, FTA = free throw attempts and Y = 0.44 factor was suggested by kenpom.
