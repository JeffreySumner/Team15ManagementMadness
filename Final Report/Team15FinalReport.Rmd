...
From the summary of the baseline models, about 40 features (of the original 78) were statistically significant. Of note, the
...
-   To find the best lambda value for LASSO,
    ...
    then used the coefficients using the lambda value that was one standard error away from that minimized the
