...
<can probably move this to the feature engineering section>
...
For our simple exploratory model, we used a logit model with only a few of our features (turnovers, possessions, points, rebounds, offensive rating and defensive rating).
...
-   <To be updated> To find the best lambda value for LASSO, we used
    ...
    Royalty]
    - season new results: 93 to 47 features...
      - ratings made the cut, but home-distance traveled is not
      
    - roll5: 93 to 18 features...
