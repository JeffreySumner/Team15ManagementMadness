...
The goal of our project is to create a multiple regression model to
predict attendance at NCAA tournament games given different match ups
between teams and other pre-game characteristics, along with building a
logistic model that will predict the outcome of the games.
...
Data Transformations: - Eliminate 2020, 2021 - Proximity to Home =
distance between City of game and Hometown location, coordinates
(latitude / longitude differential) - Jeffrey's "geocoder" based on
addresses - Momentum = Winning / losing streak (or last 5 or 10 games) -
Win Quality = Quadrants ("Quad I, II, III, IV win / loss") (Hopefully
try to find, but could create it), point differential \* (Home or
away) - Stat_differential = Possibly with player stats, Team game
results - Tournament_Stage

Types of Models: GLM: Attendance = Team_Fan_Base + Game_Excitement +
Proximity_to_Home + Momentum + Current_Record + Capacity_of_Site +
Tournament_Stage
