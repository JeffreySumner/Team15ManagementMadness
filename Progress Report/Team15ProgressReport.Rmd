...
To collect data on AP poll rankings, the author wrote a web-scraping
...
For attendance data, the author used the game_id identifier to query the
ESPN API and retrieve data on attendance. They also attempted to use the
hoopR package, which had data in its repository files, but ultimately
used the ESPN API.

Similarly, the author used the hoopR package to retrieve betting data
...
Finally, the author processed and merged all of the collected data into
